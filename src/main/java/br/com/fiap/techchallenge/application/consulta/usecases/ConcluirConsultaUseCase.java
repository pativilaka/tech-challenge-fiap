...
import br.com.fiap.techchallenge.application.consulta.ports.in.IConcluirConsulta;
...
public class ConcluirConsultaUseCase implements IConcluirConsulta {

    private final IConsultaRepository repository;
    private final IConsultaPresenter presenter;

    public ConcluirConsultaUseCase(IConsultaRepository repository, IConsultaPresenter presenter) {
